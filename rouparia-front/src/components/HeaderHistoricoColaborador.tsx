...
export default function HeaderHistoricoColaborador({ tipo }: props) {
    ...
    const excluir = () => {
        ...
        return (
          <>
            {/* Cabeçalho principal */}
            <div className={`flex sticky top-0 flex-row justify-between py-6 px-3 md:px-8 items-center w-full h-[10vh] bg-verde-primario`}>
              ...
              <button className="cursor-pointer group" onClick={() => router.replace('/home')}>
              ...
              <div className="hidden lg:flex items-center space-x-4">
                  <>
                  <Link href={'/pendencias'} className="text-white p-1 px-8 rounded-lg font-poppins-regular cursor-pointer hover:text-laranja-hover">Pendências</Link>
                ...
                <div className="flex flex-col space-y-4">
                    <>
                      ...
                      <ButtonCadastrarExcluir 
                        ...
                        texto="Excluir" 
                      />
                      <Link href={'/pendencias'} className="bg-laranja text-white p-1 px-8 rounded-lg font-poppins-regular cursor-pointer">Pendencias</Link>
                    </>
